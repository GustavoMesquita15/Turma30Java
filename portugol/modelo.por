programa
{
	...
	{	/*
		...
		*/
	cadeia mercadoria[10]={"ps5","ps4 Pro","xbox 360","xbox X Series","ps3","controle Xbox","Controle PS4","Pc Gamer","Controle PC","Teclado Gamer"}
     inteiro unidades [10] ={10,10,10,10,10,10,10,10,10,10}
     real preco [10] = {5000.20,2000.15,899.99,3000.50,900.45,120.99,140.99,129.01,200.99,140.99}
     cadeia continuar
     cadeia continuar2
